...
const LaunchSelectionModal: React.FC<LaunchSelectionModalProps> = ({ isOpen, repository, launchables, onSelect, onClose }) => {
  ...
  return (
    <div
      ...
      aria-modal="true"
      onMouseDown={onClose}
      data-automation-id="launch-selection-modal"
    >
      <div
      ...
      >
        <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
          ...
          <button
            ...
            data-automation-id="launch-selection-close"
          >
                    ...
                    return (
                        <li key={index}>
                            <button
                                ...
                                data-automation-id={`launch-selection-item-${isManual ? launchable.config.id : index}`}
                            >
