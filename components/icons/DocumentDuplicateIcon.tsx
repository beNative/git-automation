...
const HeroDocumentDuplicateIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
export const DocumentDuplicateIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
    ...
    if (iconSet === 'lucide' || iconSet === 'feather') {
        return <LucideCopyIcon {...props} />;
    }
    if (iconSet === 'tabler' || iconSet === 'remix') {
        return <TablerCopyIcon {...props} />;
    }
    return <HeroDocumentDuplicateIcon {...props} />;
};
